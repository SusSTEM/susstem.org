...
export function VolunteerPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://lh3.googleusercontent.com/d/17JO5YtAtVqLuAeFK7-m6jPBTCtbuFRwp')",
        backgroundSize: "cover",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
      }}
    >
      {/* overlay controls background “opacity” */}
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom right, rgba(7,45,45,0.9), rgba(10,59,59,0.9), rgba(32,89,58,0.9))",
          }}
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Join our community of educators and changemakers inspiring the
              next generation through hands-on STEM learning.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[540px] mx-auto px-4 py-16">
          <div
            className="bg-white/90 shadow-lg p-7 md:p-8"
