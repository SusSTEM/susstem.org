      ...
      <div className="bg-gradient-to-br from-[#072d2d] via-[#0a3b3b] to-[#20593a] text-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl font-[Inter,sans-serif] opacity-95">
            Join our global community of educators and changemakers inspiring the next generation through hands-on STEM learning.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Tell us about your passion for STEM education and sustainability..."
              />
            </div>
