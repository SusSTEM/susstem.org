        ...
        <div className="max-w-7xl mx-auto px-6 p-8 md:p-12 ">
          <div className="text-center mb-12">
            ...
            <p className="text-[#072d2d] text-xl max-w-3xl mx-auto">
              Students design devices to solve real sustainability problems in
              their community
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
            {/* Left: How It Works style cards */}
            <div className="space-y-4">
              <p className="text-[#072d2d] text-lg mb-8">
                A multi-sensor system monitors water conditions and turns them
                into easy-to-read visual signals. Learners explore how changing
                readings can show when water is safe to use, needs monitoring,
                or may be unsafe.
              </p>
              ...
              <p className="text-[#072d2d] text-base mt-6 italic">
                This project helps students understand how sensing and data can
                support better decisions about water use in their communities.
              </p>
            </div>
