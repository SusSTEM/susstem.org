...
import { Download, Mail, Target, Cpu, Code, MapPin, Lightbulb, Presentation, Droplets, TrendingUp, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage className="text-[#20593a]">Innovator Level</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <section className="bg-[#eff2e7] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-[#072d2d] text-[#a4ff7b] hover:bg-[#ffd459]/80 hover:text-[#072d2d] mb-6 px-6 py-2 rounded-full text-base">Level 2</Badge>
            <h1 className="text-[#000000] mb-6" style={{ fontSize: "48px", fontWeight: 700, lineHeight: 1.2 }}>Innovator: For Ages 11-18</h1>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Target, title: "Apply SusSTEM principles to community problems" },
              { icon: Cpu, title: "Design and build multi-sensor Arduino systems" },
              { icon: Code, title: "Program simple conditional logic and data collection" },
              { icon: MapPin, title: "Identify sustainability challenges in your environment" },
              { icon: Lightbulb, title: "Prototype solutions with real-world impact" },
              { icon: Presentation, title: "Present and refine your designs" },
            ].map((outcome, index) => (
              <div key={index} className="bg-[#eff2e7] p-6 rounded-2xl hover:shadow-lg transition-all duration-300 group hover:scale-[1.02]">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#ffd459]/80 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#ff9b69] transition-colors duration-300">
      ...
      <section className="py-16 md:py-24 bg-[#eff2e7]">
        <div className="bg-[#ffd459]/80 max-w-4xl mx-auto text-center px-6 p-8 md:p-12 rounded-3xl shadow-md mt-8">
          ...
          <p className="text-[#000000] text-lg leading-relaxed mb-8">
            Rivers, lakes, and groundwater in many parts of South Asia and around the world are under growing pressure from pollution and overuse. When factories, farms, and households release untreated waste into waterways, they introduce invisible chemicals and microbes that can spread far beyond the place where the pollution started. Over time, this contamination can lead to serious health problems, damage to local ecosystems, and unsafe drinking water for entire communities.
          </p>
          <div className="mt-8 flex justify-center">
            <div className="w-full rounded-3xl overflow-hidden shadow-lg">
              <ImageWithFallback src="https://lh3.googleusercontent.com/d/1mEw31noBCxE5c0d5JYs9rbutjZPc7rAj" alt="Pollution of Water Bodies" className="w-full h-64 md:h-80 object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="text-[#000000] mb-4" style={{ fontSize: "36px", fontWeight: 700, lineHeight: 1.3 }}>Featured Project</h2>
            <h3 className="text-[#20593A] mb-3" style={{ fontSize: "28px", fontWeight: 600, lineHeight: 1.4 }}>Community Impact Project – Water Quality Monitor</h3>
            <p className="text-[#072d2d] text-xl mb-8 p-8 md:p-10">
              A multi-sensor system monitors several water quality readings at once and translates them into simple, colored indicators that anyone can understand at a glance.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
            <div className="space-y-4">
              <div className="bg-[#5978ff]/60 p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-start gap-4">
                <div className="w-12 h-12 bg-transparent rounded-full flex items-center justify-center flex-shrink-0">
                  <Droplets className="w-7 h-7 text-white" />
                </div>
                <div>
                  <h4 className="text-[#000000] mb-2" style={{ fontSize: "20px", fontWeight: 600 }}>Clean Water Indicator</h4>
                  <p className="text-[#072d2d]">Shows when measured water conditions fall in a safe range.</p>
                </div>
              </div>
              <div className="bg-[#ffd459] p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-start gap-4">
                <div className="w-12 h-12 bg-transparent rounded-full flex items-center justify-center flex-shrink-0">
                  <TrendingUp className="w-7 h-7 text-white" />
                </div>
                <div>
                  <h4 className="text-[#000000] mb-2" style={{ fontSize: "20px", fontWeight: 600 }}>Monitor Conditions</h4>
                  <p className="text-[#072d2d]">Highlights when readings are changing and should be watched more closely.</p>
                </div>
              </div>
              <div className="bg-[#ff9b69] p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[#000000] mb-2" style={{ fontSize: "20px", fontWeight: 600 }}>Contamination Alert</h4>
                  <p className="text-[#072d2d]">Signals when measurements suggest the water may not be safe to use.</p>
                </div>
              </div>
            </div>
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <ImageWithFallback src="https://lh3.googleusercontent.com/d/1K15BUjrs3EpEBAxihSm_3B-CKk7sOyDL" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
