      ...
      <section className="bg-[#eff2e7] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-[#072d2d] text-[#a4ff7b] hover:bg-[#a2bb65]/70 hover:text-[#072d2d] mb-6 px-6 py-2 rounded-full text-base">Level 1</Badge>
            <h1 className="text-[#000000] mb-6" style={{ fontSize: "48px", fontWeight: 700, lineHeight: 1.2 }}>Explorer: For Ages 11-14</h1>
            <p className="text-[#072d2d] text-xl md:text-2xl mb-12">First steps in building smart, sustainable circuits for real-world change</p>
      ...
      <section className="py-16 md:py-24 bg-[#eff2e7]">
        <div className="bg-[#a2bb65CC] max-w-4xl mx-auto text-center px-6 p-8 md:p-12 rounded-3xl shadow-md mt-8">
          ...
          <div className="mt-8 flex justify-center">
            <div className="w-full rounded-3xl overflow-hidden shadow-lg">
              <ImageWithFallback src="https://lh3.googleusercontent.com/d/1Q2kbe5qYh8FhsYTQH8d3JovPMktCAyDD" alt="Forest Fires" className="w-full h-64 md:h-80 object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="mb-4" style={{ fontSize: "36px", fontWeight: 700, lineHeight: 1.3, color: "#000000" }}>
              Featured <span style={{ color: "#20593a" }}>SusSTEM</span> Solution
            </h2>
            <h3 className="text-black mb-3" style={{ fontSize: "28px", fontWeight: 600, lineHeight: 1.4 }}>Air Alert - Environmental Monitoring System</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
            <div className="space-y-4">
              <div className="bg-[#a2bb65] p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-start gap-4">
              ...
              <div className="bg-[#ff9b69e7] p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-start gap-4">
                <div className="w-12 h-12 bg-transparent rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <ImageWithFallback src="https://lh3.googleusercontent.com/d/1AZ1ybv4_kiCsbqpZHrka9xsH6twAHG2F" className="w-full h-92 object-cover" />
            </div>
          </div>
        </div>
      </section>
